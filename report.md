...
При 180 пользователях появляются первые 500, однако они составляют всего 5% от общего числа запросов. При уменьшении ramp-up периода до 1с и увеличении кол-ва пользователей до 200, кол-во неуспешных запросов увеличивается до 14%. При дальнейшем увеличении нагрузки кол-вол 500 не превышает 25% - система хорошо держит нагрузку, хотя запросы и выполняются очень долго. На скрине - 500 пользователей, 200 rpm, 0 ramp-up
